...
# -*- coding: utf-8 -*-
# History:
#  v1.2, wangyuguang, fix cache problemt.
...
class BPE(object):
    ...
    def segment(self, sentence):
        ...
        for word in sentence.split():
            ...
            #if self.num_total % 100000 == 0:
            #   print "total %s, hit %s, missed %s"%(self.num_total, self.num_hit, self.num_total - self.num_hit)
